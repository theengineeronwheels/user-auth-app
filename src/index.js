...
app.use(
  session({
    secret: process.env.SESSION_SECRET || "your_session_secret", // Session secret from environment variable
    resave: false,
    saveUninitialized: false, // Only save sessions if they are modified
    cookie: {
      httpOnly: true,
...
// Helper function to perform async database queries
